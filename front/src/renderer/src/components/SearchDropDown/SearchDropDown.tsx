...
interface SearchDropDownTypes {
    searchDropRef: React.MutableRefObject<HTMLElement | null>,
    selectSearchDropdown: boolean
}

const SearchDropDown = ({ searchDropRef, selectSearchDropdown }: SearchDropDownTypes) => {
    return (
            ...
            <div data-kt-search-element="wrapper">
                ...
                <div data-kt-search-element="results" className="d-none">
                    ...
                    <div className="scroll-y mh-200px mh-lg-350px">
                        ...
                        {/*end::Category title*/}
                        {/*begin::Item*/}
                        <button className="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                            {/*begin::Symbol*/}
